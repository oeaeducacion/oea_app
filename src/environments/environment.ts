...
export const environment = {
  production: true,
  firebaseConfig: {
    apiKey: 'AIzaSyAgCYdLElfssAJccBcoU8LU2kLc-EtNRmg',
    authDomain: 'oea-educacion.firebaseapp.com',
    projectId: 'oea-educacion',
    storageBucket: 'oea-educacion.appspot.com',
  ...
  /*JORDAN*/
  // urlAddress: 'http://192.168.0.39:8000/api/'
};
/*
